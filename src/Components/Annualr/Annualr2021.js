...
<div className="bg-[url('https://static.igem.org/mediawiki/2021/7/79/T--UPF_Barcelona--omegaA_anim.PNG')] bg-cover bg-fixed">
    ...
    >
      <div className='container py-8 mx-auto min-h-[600px]'>
        ...
        <p className="text-center bg-yellow-400 hover:bg-teal-500 hover:text-yellow-400 mx-auto rounded-3xl py-2 w-[150px]"><a href={annualr2023} download="annual-report-2021.pdf" >Download</a></p>
        </div>
            </div>
