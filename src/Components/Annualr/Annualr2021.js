    ...
    >
      <div className='container py-8 mx-auto min-h-[600px]'>
        <div className='  rounded-xl    pb-12 flex flex-col    '>
          ...
          <a href={annualr2021} download="annual-report-2021.pdf" ><p className="text-center bg-yellow-400 hover:bg-teal-500 hover:text-yellow-400 mx-auto rounded-3xl py-2 w-[150px]">Download</p></a>
        </div>
            </div>
