...
const Annualr2022 = () =>{
  ...
  const docs = [
    { uri: require("../assests/annualr/annualr2022.pdf") }, // Local File
  ];
            ...
            <div className='container py-8 mx-auto min-h-[600px]'>
              <div className='  rounded-xl    pb-12 flex flex-col    '>
                <div className='flex-1 rounded-tr-xl rounded-tl-xl  '>
                  <h2 className='h2 mb-10 px-4 pb-4 pt-2 bg-white rounded-2xl w-[240px] font font-black text-blue-800 te text-xl xt-md' >
                  Annual Report 2022
                  </h2>
              ...
              <a href={annualr2022} download="annual-report-2022.pdf" ><p className="text-center bg-yellow-400 hover:bg-teal-500 hover:text-yellow-400 mx-auto rounded-3xl py-2 w-[150px]">Download</p></a>
              </div>
                  </div>
      
                  {/* <iframe height={800} width={600} className="mx-auto py-11" src={annualr2021}></iframe> */}
      <div className='py-4'>
                <p className='text-2xl text-center font-bold  bg-white rounded-2xl w-[150px] mx-auto py-1'>Preview</p>
                </div>   
