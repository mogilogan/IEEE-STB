...
<footer class=" text-center text-white bg-white">
  <div class="container pt-9">
    <div class="mb-9    justify-center">
      
     
      <div className="flex mx-auto justify-center">
      <a href="https://www.instagram.com/ptu_ieee_sb/" target="_blank" class=" lg:pl-[30px] mr-9 text-neutral-800 ">
        <svg
      ...
      <button onclick="location.href='mailto:cic@ptuniv.edu.in';"class="mr-9 text-neutral-800 ">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="h-4 w-4"
          fill="currentColor"
